...
You can find an [example that is filled out](https://github.com/dfinity/ic/blob/master/rs/sns/cli/test_sns_init_v2.yaml) which you may also use as a template.
